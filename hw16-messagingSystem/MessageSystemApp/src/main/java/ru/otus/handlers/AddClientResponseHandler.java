...
@Component("addClientResponseHandler")
public class AddClientResponseHandler implements RequestHandler<ClientDto> {
    private static final Logger logger = LoggerFactory.getLogger(GetClientDataResponseHandler.class);

    private final CallbackRegistry callbackRegistry;

    public AddClientResponseHandler(CallbackRegistry callbackRegistry) {
